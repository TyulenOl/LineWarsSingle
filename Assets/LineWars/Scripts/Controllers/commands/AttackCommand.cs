...
namespace LineWars.Model
{
    ...
    {
        private readonly AttackAction<TNode, TEdge, TUnit, TOwned, TPlayer, TNation> attackAction;
        ...
        public AttackCommand([NotNull] TUnit attacker, [NotNull] IAlive defender)
        {
            ...
            attackAction = attacker.TryGetUnitAction<AttackAction<TNode, TEdge, TUnit, TOwned, TPlayer, TNation>>(out var action) 
                ? action 
                : throw new ArgumentException($"{Attacker} does not contain {nameof(AttackAction<TNode, TEdge, TUnit, TOwned, TPlayer, TNation>)}");
        }

        public AttackCommand(
            [NotNull] AttackAction<TNode, TEdge, TUnit, TOwned, TPlayer, TNation> attackAction,
