...
{
    public class SacrificePerunCommand<TNode, TEdge, TUnit, TOwned, TPlayer> : 
        ...
        #endregion
    {
        ...
        public SacrificePerunCommand([NotNull] TUnit unit, [NotNull] TNode node)
        {
