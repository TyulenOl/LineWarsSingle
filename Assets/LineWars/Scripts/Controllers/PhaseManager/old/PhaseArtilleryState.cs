...
{
    public class PhaseArtilleryState : State
    {
        private readonly PhaseManager manager;
        private readonly Action<PhaseType> setNewPhase;
        
        private int actorId;
        public bool AreActorsDone => !manager.Actors.Any((actor) => actor.CanExecuteTurn(PhaseType.Artillery));

        public PhaseArtilleryState(PhaseManager manager, Action<PhaseType> setNewPhase)
        {
