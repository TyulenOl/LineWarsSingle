...
namespace LineWars.Model
{
    public struct Hit
    {
        public ModelComponentUnit Source { get; }
        public IAlive Destination { get; }
        public int Damage { get; }
        public bool IsPenetrating { get; }
        public bool IsRangeAttack { get; }

        public Hit(int damage, ModelComponentUnit source, IAlive destination, bool isPenetrating = false, bool isRangeAttack = false)
        {
