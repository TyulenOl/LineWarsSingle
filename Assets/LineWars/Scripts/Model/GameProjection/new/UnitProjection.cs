...
namespace LineWars.Model
{
            ...
            BasePlayerProjection>, IReadOnlyUnitProjection
    {
            ...
            NodeProjection node = null)
        {
            ...
            foreach(var action in actions)
            {
                actionsDictionary[action.GetMyCommandType()] =
                    UnitActionConverterFromMono<NodeProjection, EdgeProjection,
                    UnitProjection, OwnedProjection,
                    BasePlayerProjection>.Convert(this, action);
            }
        }
            ...
            NodeProjection node = null)
        {
            ...
            {
                actionsDictionary[action.GetMyCommandType()] =
                    UnitActionDuplicator<NodeProjection, EdgeProjection,
                    UnitProjection, OwnedProjection, BasePlayerProjection>.Duplicate(this, action);
            }
        }
