...
namespace LineWars.Model
{
    public class ConvertMonoActionVisitor : IMonoUnitVisitor
    {
        ...
        {
            Result = new BuildAction<NodeProjection, EdgeProjection, UnitProjection, OwnedProjection, BasePlayerProjection>
                (Unit);
        ...
        {
            Result = new BlockAction<NodeProjection, EdgeProjection, UnitProjection, OwnedProjection, BasePlayerProjection>
        ...
        {
            Result = new HealAction<NodeProjection, EdgeProjection, UnitProjection, OwnedProjection, BasePlayerProjection>
        ...
        {
            Result = new DistanceAttackAction<NodeProjection, EdgeProjection, UnitProjection, OwnedProjection, BasePlayerProjection>
        ...
        {
            Result = new ArtilleryAttackAction<NodeProjection, EdgeProjection, UnitProjection, OwnedProjection, BasePlayerProjection>
                (Unit, action.Damage, action.IsPenetratingDamage, action.Distance, Graph);
            Result.ActionModifier = action.Action.ActionModifier;
        }
        ...
        {
            Result = new MeleeAttackAction<NodeProjection, EdgeProjection, UnitProjection, OwnedProjection, BasePlayerProjection>
