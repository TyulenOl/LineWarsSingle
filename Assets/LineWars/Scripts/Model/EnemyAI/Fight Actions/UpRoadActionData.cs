...
namespace LineWars.Model
{
    ...
    public class UpRoadActionData : EnemyActionData
    {
        ...
        public override void AddAllPossibleActions(List<EnemyAction> list, EnemyAI basePlayer, IExecutor executor)
        {
            ...
            EnemyActionUtilities.GetNodesInIntModifierRange(engineer.Node, engineer.CurrentActionPoints,
                ...
                ((prevNode, node, range) => NodeParser(prevNode, node, range, engineer, edgeSet, basePlayer, list)), engineer);
        }
    ...
    public class UpRoadAction : EnemyAction
    {
        ...
        private readonly UpRoadActionData data;
        
        public UpRoadAction(EnemyAI basePlayer, IExecutor executor, Node node, Edge edge, UpRoadActionData data) : base(basePlayer, executor)
        {
        ...
        public override void Execute()
        {
            ...
            IEnumerator ExecuteCoroutine()
            {
                foreach (var node in path)
                {
                    ...
                    UnitsController.ExecuteCommand(new MoveCommand(engineer, engineer.Node, node));
        ...
        private float GetScore()
        {
            ...
            var enemiesCount = basePlayer.OwnedObjects
                .Where((owned => owned is Unit unit && unit.MovementLineType == upgradedType))
                .Count();
            if (enemiesCount >= 1)
