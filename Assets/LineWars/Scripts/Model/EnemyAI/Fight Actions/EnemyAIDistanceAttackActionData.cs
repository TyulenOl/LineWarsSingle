...
namespace LineWars.Model
{
    ...
    public class EnemyAIDistanceAttackActionData : EnemyActionData
    {
        ...
        public override void AddAllPossibleActions(List<EnemyAction> actionList, EnemyAI basePlayer, IExecutor executor)
        {
            ...
            var enemySet = new HashSet<Unity.VisualScripting.Unit>();
        ...
        private void NodeParser(Node previousNode, Node node, int actionPoints, DistanceAttackUnit distanceUnit, 
            HashSet<Unity.VisualScripting.Unit> enemySet, List<EnemyAction> list, EnemyAI basePlayer)
        {
        ...
        private List<Unity.VisualScripting.Unit> CheckDistanceAttack(Node node, DistanceAttackUnit distanceUnit, HashSet<Unity.VisualScripting.Unit> enemySet)
        {
            var list = new List<Unity.VisualScripting.Unit>();
            var attackedNodes =
    ...
    public class DistanceAttackAction : EnemyAction
    {
        ...
        private readonly Unity.VisualScripting.Unit target;
        private readonly DistanceAttackUnit distanceUnit;
        private readonly List<Node> path;
        private readonly DistanceUnitAttackActionData data;
        public DistanceAttackAction(EnemyAI basePlayer, IExecutor executor, Node node, Unity.VisualScripting.Unit targetUnit, DistanceUnitAttackActionData data) : base(basePlayer, executor)
        {
